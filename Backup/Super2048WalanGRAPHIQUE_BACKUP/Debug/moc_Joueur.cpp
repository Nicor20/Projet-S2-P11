...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Joueur_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Joueur_t qt_meta_stringdata_Joueur = {
    {
QT_MOC_LITERAL(0, 6) // "Joueur"
...
const QMetaObject Joueur::staticMetaObject = { {
    QMetaObject::SuperData::link<QGraphicsRectItem::staticMetaObject>(),
    qt_meta_stringdata_Joueur.offsetsAndSize,
    qt_meta_data_Joueur,
    qt_static_metacall,
    nullptr,
    nullptr,
...
void *Joueur::qt_metacast(const char *_clname)
{
    ...
    return QGraphicsRectItem::qt_metacast(_clname);
}

int Joueur::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QGraphicsRectItem::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
